// src/app/visualizers/bellman-ford/types.ts
...
export interface GraphNode {
  ...
  color?: string;
  isStartNode?: boolean;
  distance?: number | typeof Infinity; // For pathfinding algorithms
}
...
export interface GraphAlgorithmStep {
  ...
  message?: string;
  auxiliaryData?: Array<{
    type: 'queue' | 'stack' | 'set' | 'table' | 'info'; // Type of auxiliary data structure or info
    label: string; // E.g., "Priority Queue", "Distances", "Current Iteration K"
    values: any;   // Could be string[], string[][], Record<string, any>, etc.
  }>;
