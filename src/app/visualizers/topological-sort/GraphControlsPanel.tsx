...
export function GraphControlsPanel({
  ...
  onGraphInputChange,
  graphInputValue,
  onStartNodeChange, // Will be undefined for Topo Sort
  startNodeValue,   // Will be undefined
  showStartNodeInput = false, // Explicitly set to false for Topo Sort
  isPlaying,
  isFinished,
  currentSpeed,
  onSpeedChange,
  ...
  minSpeed,
  maxSpeed,
  graphInputPlaceholder = "e.g., 0:1,2;1:3 (node:neighbors;...)",
  onExecute,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
          <div className="space-y-2 md:col-span-2"> {/* Make input span full width */}
            <Label htmlFor="graphInput" className="text-sm font-medium flex items-center">
              <Network className="mr-2 h-4 w-4 text-muted-foreground" /> Graph Data (Directed Acyclic Graph)
            </Label>
            <Input
              id="graphInput"
              type="text"
