...
export function FloydWarshallCodePanel({ codeSnippets, currentLine, defaultLanguage = "JavaScript" }: FloydWarshallCodePanelProps) {
  ...
  const handleCopyCode = () => {
    ...
    if (codeToCopy && selectedLanguage !== 'Info') {
      navigator.clipboard.writeText(codeToCopy)
        .then(() => {
          toast({ title: `${selectedLanguage} Floyd-Warshall Code Copied!` });
        })
        .catch(err => {
