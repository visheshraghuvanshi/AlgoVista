...
const LCS_CODE_SNIPPETS = {
  JavaScript: [
    ...
    "        // Characters match, LCS length increases by 1 from previous diagonal",
    "        dp[i][j] = 1 + dp[i - 1][j - 1];",
    "      } else {",
    "        // Characters don't match, take max from top or left cell",
             ...
             <Card className="shadow-lg rounded-lg h-auto flex flex-col">
                ...
                <CardContent className="flex-grow overflow-hidden p-0 pt-2 flex flex-col">
                    ...
                    <pre className="font-code text-sm p-4">
                        {LCS_CODE_SNIPPETS.JavaScript.map((line, index) => (
