...
const ALGORITHM_SLUG = 'graph-cycle-detection';
...
export default function GraphCycleDetectionVisualizerPage() {
  ...
  const algoDetails: AlgorithmDetailsProps | null = algorithm ? {
    ...
    spaceComplexity: "O(V) for visited array and recursion stack (DFS).",
  } : null;
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center my-10 p-6 border rounded-lg shadow-lg bg-card">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
                The interactive visualizer for {algorithm.title}, demonstrating how DFS or other methods detect cycles by identifying back-edges, is under construction.
