      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-muted-foreground text-lg">
              Could not load data for &quot;{algorithmMetadata?.slug || 'Sudoku Solver'}&quot;.
            </p>
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center my-10 p-6 border rounded-lg shadow-lg bg-card">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
                The interactive visualizer for {algorithmMetadata.title}, showing how numbers are tried and backtracking occurs, is currently under construction.
