...
import { Button } from "@/components/ui/button"; // ShadCN UI component, not algo-vista
...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"; // ShadCN UI component
import { Slider } from "@/components/ui/slider"; // ShadCN UI component

interface SortingControlsPanelProps {
  onPlay: () => void;
  onPause: () => void;
  onStep: () => void;
  onReset: () => void;
    ...
    <Card className="shadow-xl rounded-xl">
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
          <div className="space-y-2 md:col-span-2"> {/* Make input span full width if no target */}
