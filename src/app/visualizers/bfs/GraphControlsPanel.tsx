...
export function GraphControlsPanel({
  ...
  const commonPlayDisabled = isFinished || isInputEmpty || isStartNodeEmpty || !isAlgoImplemented;
  const commonStepDisabled = isPlaying || isFinished || isInputEmpty || isStartNodeEmpty || !isAlgoImplemented;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g., 0:1,2;1:0;2:0 (node:neighbors;...)"
