...
interface ConnectedComponentsCodePanelProps {
  codeSnippets: { 
    ...
    directed: { [language: string]: string[] } // For SCCs
  };
...
export function ConnectedComponentsCodePanel({ codeSnippets, currentLine, graphType, defaultLanguage = "JavaScript" }: ConnectedComponentsCodePanelProps) {
  ...
  const handleCopyCode = () => {
    ...
    if (codeToCopy && selectedLanguage !== 'Info') {
      navigator.clipboard.writeText(codeToCopy)
        .then(() => {
          toast({ title: `${selectedLanguage} Code for ${graphType} Components Copied!` });
        })
        .catch(err => {
