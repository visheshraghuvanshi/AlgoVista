// src/app/visualizers/prims-algorithm/GraphVisualizationPanel.tsx
"use client";
...
const EDGE_COLOR_RELAXED = "hsl(var(--primary))"; // For Dijkstra, also good for MST edge
const EDGE_COLOR_TRANSPOSE = "hsl(var(--purple-500))"; 
const EDGE_COLOR_CONSIDERED = "hsl(var(--accent))"; // For Prim's/Kruskal's edge under consideration
